function [alljs,alljfg,allX,allY]=benchmark_inl2(mysystem,datadir,mode)
...
for ii=1:length(a)
    ...
    if strcmp(ext,'.jpg')
        ...
        try
            ...
            blubb = exist(mysystem.segmenter,'file');
            if blubb == 2
                disp('The function seems to exist');
            elseif blubb == 0
                disp('The function does not exist, maybe you need to add some paths?');
            else
