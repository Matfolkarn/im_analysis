...
%% GAUSIAN
x = linspace(0,2,100);
data = [0.4003 ; 0.3988 ; 0.3998 ; 0.3997;0.4010 ; 0.3995 ; 0.3991; 0.2554 ; 0.3139 ; 0.2627 ; 0.3802 ;0.3287 ; 0.3160 ; 0.2924 ; 0.5632 ; 0.7687 ; 0.0524 ; 0.7586; 0.4243 ; 0.5005 ; 0.6769 ];
for d = 1:length(data)
    current = data(d);
