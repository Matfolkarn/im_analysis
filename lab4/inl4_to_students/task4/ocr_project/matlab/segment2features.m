...
eulernumber = (eulernumber + 1.5)/1.5
%perimeter
...
features = [eulernumber, n_white, hole_size, wid, eccentricityValue, normalizedPerimeter, feat5, feat6]
